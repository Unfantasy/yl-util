...
var _internalRoot = _interopRequireDefault(require("./internalRoot.js"));
...
function debounce(func, wait, options) {
  ...
  const useRAF = !wait && wait !== 0 && typeof _internalRoot.default.requestAnimationFrame === 'function';
  ...
  function startTimer(pendingFunc, wait) {
    if (useRAF) {
      _internalRoot.default.cancelAnimationFrame(timerId);

      return _internalRoot.default.requestAnimationFrame(pendingFunc);
    }
  ...
  function cancelTimer(id) {
    if (useRAF) {
      return _internalRoot.default.cancelAnimationFrame(id);
    }
